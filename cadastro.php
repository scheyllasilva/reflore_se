            ...
            <div class="card">
                <div class="card-header" id="headingOne">
                    <h7 class="mb-0">
                        <div class='form-row'>
                            <div class="radio">
                                <label><input type="radio" name="optradio" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Pessoa Fisica</label>
                            </div>
                            <div class="radio">
                                <label><input type="radio" name="optradio" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Pessoa Juridica</label>
                            </div>
                        </div>
                    </h7>
                </div>
